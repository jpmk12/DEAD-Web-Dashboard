...
export const AMC_HUBS: { region: string; hubs: AmcHub[] }[] = [
  {
    region: "CONUS & Alaska",
    hubs: [
      { icao: "KSUU", name: "Travis AFB, CA", lat: 38.2627, lon: -121.927 },
      { icao: "KDOV", name: "Dover AFB, DE", lat: 39.1296, lon: -75.467 },
      { icao: "KCHS", name: "JB Charleston, SC", lat: 32.8986, lon: -80.0405 },
      { icao: "KWRI", name: "JB MDL (McGuire), NJ", lat: 40.0155, lon: -74.5917 },
  ...
  },
  {
    ...
    hubs: [
      { icao: "ETAR", name: "Ramstein AB, DE", lat: 49.4369, lon: 7.6003 },
  ...
  },
  {
    region: "Indo-Pacific",
    hubs: [
      { icao: "PHIK", name: "JB Pearl Harbor-Hickam, HI", lat: 21.3187, lon: -157.9224 },
      { icao: "PGUA", name: "Andersen AFB, Guam", lat: 13.584, lon: 144.93 },
